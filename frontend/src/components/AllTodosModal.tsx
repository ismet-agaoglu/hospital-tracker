...
export default function AllTodosModal({ patients, onClose, onUpdate }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-4 pb-20 md:pb-4 bg-black/50 backdrop-blur-sm overflow-y-auto"
      onClick={onClose}
    >
      <div
        className="bg-white rounded-2xl max-w-3xl w-full h-[calc(100vh-140px)] md:h-auto md:max-h-[90vh] overflow-hidden shadow-2xl my-auto flex flex-col"
