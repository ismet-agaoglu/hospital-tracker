...
export default function ServicePanel() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-20 md:pb-8 overflow-x-hidden">
      {/* Minimal Header */}
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <h1 className="text-lg md:text-xl font-semibold text-slate-900 dark:text-slate-100 truncate">Servis • {selectedClinic.name}</h1>
            <div className="flex items-center space-x-1 md:space-x-2">
              ...
              <button
                ...
                className="hidden md:block p-2 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors"
                title="Yapılacaklar"
              >
